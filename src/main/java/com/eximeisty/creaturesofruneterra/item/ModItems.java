...
//            () -> new FiddleArmorItem(ArmorMaterials.CHAIN, EquipmentSlot.HEAD, new Item.Properties()));
//
//    public static final RegistryObject<Item> FIDDLE_CHESTPLATE = ITEMS.register("fiddle_chestplate",
//            () -> new FiddleArmorItem(ArmorMaterials.CHAIN, EquipmentSlot.CHEST, new Item.Properties()));
//
//    public static final RegistryObject<Item> FIDDLE_BEARTRAP = ITEMS.register("fiddle_beartrap",
//            () -> new FiddleArmorItem(ArmorMaterials.NETHERITE, EquipmentSlot.HEAD, new Item.Properties().fireResistant()));
//
//    public static final RegistryObject<Item> FIDDLE_BIRDCAGE = ITEMS.register("fiddle_birdcage",
//            () -> new FiddleArmorItem(ArmorMaterials.NETHERITE, EquipmentSlot.CHEST, new Item.Properties().fireResistant()));
