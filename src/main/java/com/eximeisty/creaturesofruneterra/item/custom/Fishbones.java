...
public class Fishbones extends ProjectileWeaponItem implements IAnimatable , ISyncable{
    ...
    private static final AnimationBuilder RELOAD_ANIM = new AnimationBuilder().addAnimation("animation.fishbones.reload", ILoopType.EDefaultLoopTypes.PLAY_ONCE).addAnimation("animation.fishbones.charged", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder FIRE_ANIM = new AnimationBuilder().addAnimation("animation.fishbones.fire", ILoopType.EDefaultLoopTypes.PLAY_ONCE).addAnimation("animation.fishbones.idle", ILoopType.EDefaultLoopTypes.LOOP);
    ...
    public <P extends Item & IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        if(event.getController().getAnimationState()==AnimationState.Stopped){
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.fishbones.idle", ILoopType.EDefaultLoopTypes.LOOP));
        }
	...
	public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		tooltip.add(Component.nullToEmpty(quotes[quote]));
	}

    public boolean isValidRepairItem(ItemStack toRepair, ItemStack repair) {
        return ModItems.GEMSTONE.get()==repair.getItem() || super.isValidRepairItem(toRepair, repair);
    }
    ...
    public void initializeClient(Consumer<IItemRenderProperties> consumer) {
        ...
        consumer.accept(new IItemRenderProperties() {
            private final BlockEntityWithoutLevelRenderer renderer = new FishbonesRenderer();
