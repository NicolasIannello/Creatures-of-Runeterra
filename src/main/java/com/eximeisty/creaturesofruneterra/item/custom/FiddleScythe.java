...
public class FiddleScythe extends SwordItem implements IAnimatable {
    ...
    //private AttributeModifier reachModifier = new AttributeModifier(REACH, "Weapon modifier", 2, Operation.ADDITION);
    ...
    public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        attacker.heal(1);
        target.addPotionEffect(new EffectInstance(Effects.WITHER, 20*3));
