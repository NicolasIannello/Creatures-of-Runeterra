...
public class NaafiriModel extends AnimatedGeoModel<NaafiriEntity> {
    ...
    @Override
    public void setLivingAnimations(NaafiriEntity animatable, Integer instanceId, @Nullable AnimationEvent animationState) {
        ...
        if(animatable.getDataManager().get(NaafiriEntity.ATTACK)==0){
            if (head != null) {
