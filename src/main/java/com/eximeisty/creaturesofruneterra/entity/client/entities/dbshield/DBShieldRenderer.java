...
public class DBShieldRenderer extends GeoProjectilesRenderer<DBShieldEntity> {
    ...
    @Override
	public RenderType getRenderType(DBShieldEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
