...
public class LanternEmissiveLayer extends GeoLayerRenderer {
    private static final ResourceLocation LAYER = new ResourceLocation(CreaturesofRuneterra.MOD_ID, "textures/entity/fiddlesticks-emissive2.png");
    ...
    public LanternEmissiveLayer(IGeoRenderer entityRendererIn) {
