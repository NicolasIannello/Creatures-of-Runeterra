...
public class ModEntityTypes {
    ...
    ENTITY_TYPES.register("reksai", 
        ()-> EntityType.Builder.create(RekSaiEntity::new, EntityClassification.MONSTER).immuneToFire().size(5f,5f).build(new ResourceLocation(CreaturesofRuneterra.MOD_ID, "reksai").toString())
    );
