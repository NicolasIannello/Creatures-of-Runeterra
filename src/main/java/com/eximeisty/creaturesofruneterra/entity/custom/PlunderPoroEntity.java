...
public class PlunderPoroEntity extends TamableAnimal implements GeoEntity, RangedAttackMob {
    ...
    private static final RawAnimation IDLE_ANIM = RawAnimation.begin().then("animation.plunderporo.idle", Animation.LoopType.LOOP);
    private static final RawAnimation WALK_ANIM = RawAnimation.begin().then("animation.plunderporo.walk", Animation.LoopType.LOOP);
    private static final RawAnimation SIT_ANIM = RawAnimation.begin().then("animation.plunderporo.sit", Animation.LoopType.LOOP);
    private static final RawAnimation SHOT_ANIM = RawAnimation.begin().then("animation.plunderporo.shoot", Animation.LoopType.PLAY_ONCE);
