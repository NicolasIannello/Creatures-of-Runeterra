...
public class FabledPoroEntity extends TamableAnimal implements IAnimatable {
    ...
    private static final AnimationBuilder FORGE_ANIM = new AnimationBuilder().addAnimation("animation.fabledporo.forge", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder SIT_ANIM = new AnimationBuilder().addAnimation("animation.fabledporo.sit", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder WALK_ANIM = new AnimationBuilder().addAnimation("animation.fabledporo.walk", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder IDLE_ANIM = new AnimationBuilder().addAnimation("animation.fabledporo.idle", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder ATTACK_ANIM = new AnimationBuilder().addAnimation("animation.fabledporo.attack", ILoopType.EDefaultLoopTypes.PLAY_ONCE);
