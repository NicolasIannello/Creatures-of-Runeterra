...
public class PatchedPorobotEntity extends TameableEntity implements IAnimatable{
   ...
   private static final DataParameter<Boolean> STATE = EntityDataManager.createKey(PatchedPorobotEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> OPEN = EntityDataManager.createKey(PatchedPorobotEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> CLOSE = EntityDataManager.createKey(PatchedPorobotEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Integer> BURNTIME = EntityDataManager.createKey(PatchedPorobotEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Integer> BURNTIMETOTAL = EntityDataManager.createKey(PatchedPorobotEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Integer> COOKTIME = EntityDataManager.createKey(PatchedPorobotEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Integer> COOKTIMETOTAL = EntityDataManager.createKey(PatchedPorobotEntity.class, DataSerializers.VARINT);
