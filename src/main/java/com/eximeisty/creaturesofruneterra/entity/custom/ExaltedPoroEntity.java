...
public class ExaltedPoroEntity extends TamableAnimal implements IAnimatable {
    ...
    private static final AnimationBuilder IDLE_ANIM = new AnimationBuilder().addAnimation("animation.exaltedporo.idle", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder WALK_ANIM = new AnimationBuilder().addAnimation("animation.exaltedporo.walk", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder SIT_ANIM = new AnimationBuilder().addAnimation("animation.exaltedporo.sit", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder CAST_ANIM = new AnimationBuilder().addAnimation("animation.exaltedporo.cast", ILoopType.EDefaultLoopTypes.PLAY_ONCE);
    private int ticks=0;
    private int cd;
