...
public class ModEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToSpecificBiomes(event, ModEntityTypes.XERSAI_HATCHLING.get(), 20, 1, 3, Biomes.DESERT,Biomes.BADLANDS,Biomes.WOODED_BADLANDS,Biomes.ERODED_BADLANDS, Biomes.DRIPSTONE_CAVES);
        addEntityToSpecificBiomes(event, ModEntityTypes.PORO.get(), 15, 1, 3, Biomes.SNOWY_BEACH, Biomes.SNOWY_PLAINS, Biomes.SNOWY_TAIGA, Biomes.SNOWY_SLOPES, Biomes.ICE_SPIKES, Biomes.FROZEN_PEAKS, Biomes.FROZEN_RIVER, Biomes.GROVE, Biomes.JAGGED_PEAKS);
