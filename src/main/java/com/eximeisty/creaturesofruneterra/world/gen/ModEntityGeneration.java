...
public class ModEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        ...
        addEntityToSpecificBiomes(event, ModEntityTypes.PORO.get(), 30, 1, 3, Biomes.SNOWY_BEACH, Biomes.SNOWY_PLAINS, Biomes.SNOWY_TAIGA, Biomes.SNOWY_SLOPES, Biomes.ICE_SPIKES, Biomes.FROZEN_PEAKS, Biomes.FROZEN_RIVER, Biomes.GROVE);
    }
